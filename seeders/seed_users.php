...
try{
  ...
  '$admin_password', 'Admin address', 1, '#0ea5e9', $admin_created_at, $admin_is_blocked, $admin_updated_at, $admin_deleted_at),";
  ...
  for($i = 0; $i < 100; $i++){
    ...
    '$user_address', '$user_role_fk', '$user_tag_color', $user_created_at, $user_is_blocked,  $user_updated_at, $user_deleted_at),";
  }
  $values = rtrim($values, ',');  
